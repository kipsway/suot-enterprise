...
class I18n:
    ...
    _ru: Dict[str, str] = {
        ...
        "app.version": "Версия",
        "app.copyright": "© 2024 ОхранаТруда Про",
        "login.title": "Авторизация — ОхранаТруда Про",
        ...
        "tab.violations": "⚠️ Нарушения",
        "tab.companies": "🏢 Контрагенты",
        "tab.custom_ledger": "📋 Произвольный журнал",
        "tab.statistics": "📈 Статистика",
        "tab.audit": "📁 Аудит",
        "tab.ai": "🤖 ИИ-ассистент",
        "tab.reminders": "🔔 Напоминания",
        "tab.work_orders": "📌 Предписания",
        "tab.ppe_inspection": "🔍 Инспекция СИЗ",
        "emp.id": "ID",
        "emp.fio": "ФИО",
        ...
        "filter.presets": "Сохранённые фильтры",
        "filter.save": "Сохранить фильтр",
        "filter.load": "Загрузить",
        "filter.delete": "Удалить",
        "filter.name_prompt": "Название пресета:",
        "filter.delete_confirm": "Удалить пресет «{name}»?",
        "templates.label": "Шаблоны",
        "templates.save": "Сохранить как шаблон",
        "templates.delete": "Удалить шаблон",
        "templates.select": "-- выберите шаблон --",
        "templates.name_prompt": "Название шаблона:",
        "templates.delete_confirm": "Удалить шаблон «{name}»?",
        "validation.title": "Правила валидации",
        "validation.hint": "Настройте правила проверки полей при добавлении/редактировании записей.",
        "validation.table": "Таблица",
        "validation.required": "Обязательное поле",
        "validation.min_len": "Мин. длина:",
        "validation.max_len": "Макс. длина:",
        "validation.pattern": "Регулярное выражение:",
        "validation.pattern_hint": "например: ^\\+?\\d{10,15}$",
        "validation.pattern_msg_hint": "Текст ошибки при несовпадении",
        "validation.error_title": "Ошибка валидации",
        "validation.errors_found": "Проверьте поля, отмеченные красным:",
        ...
        "ai.ollama_title": "Локальный ИИ",
        "ai.ollama_suggestion": "Советуем установить Ollama для бесплатного локального ИИ.\nСкачайте с https://ollama.ai и запустите.",
        ...
        "tab.checklists": "✅ Чек-листы",
        "tab.capa": "🔄 CAPA",
        "tab.risk": "⚠️ Риски 5×5",
        ...
        "telegram.help_employee": "Информация о сотруднике (Фамилия)",
        "telegram.help_violation": "Информация о нарушении (№)",
        "telegram.help_company": "Информация о компании (Название)",
        "telegram.help_report": "Сгенерировать отчёт",
        "telegram.help_template": "Скачать шаблон (Название)",
        "telegram.help_settings": "Настройки уведомлений",
        "telegram.help_menu": "Главное меню",
        "telegram.no_company": "Компания не найдена",
        "telegram.company_title": "Информация о компании",
        "telegram.employee_title": "Информация о сотруднике",
        "telegram.employee_not_found": "Сотрудник не найден",
        "telegram.violation_title": "Информация о нарушении",
        "telegram.violation_not_found": "Нарушение не найдено",
        "telegram.report_choose": "Выберите тип отчёта:",
        "telegram.report_generating": "Генерирую отчёт...",
        "telegram.report_ready": "Отчёт готов:",
        "telegram.template_choose": "Выберите шаблон:",
        "telegram.template_not_found": "Шаблон не найден",
        "telegram.template_ready": "Шаблон:",
        "telegram.settings_title": "Настройки уведомлений",
        "telegram.settings_hint": "Чтобы изменить настройки, используйте:\n/settings on — включить\n/settings off — отключить",
        "telegram.settings_on": "Уведомления включены",
        "telegram.settings_off": "Уведомления отключены",
        "telegram.menu_main": "Главное меню СУОТ Enterprise",
        "telegram.menu_employee": "👤 Сотрудник",
        "telegram.menu_violation": "⚠ Нарушение",
        "telegram.menu_company": "🏢 Компания",
        "telegram.menu_stats": "📊 Статистика",
        "telegram.menu_report": "📄 Отчёт",
        "telegram.menu_help": "❓ Помощь",
        "telegram.pagination_template": "Страница {page} из {total}",
        ...
        "browser.pin_tab": "Закрепить вкладку",
        "browser.unpin_tab": "Открепить вкладку",
        "browser.duplicate_tab": "Дублировать вкладку",
        "browser.rename_tab": "Переименовать вкладку",
        "browser.rename_hint": "Новое название:",
    }
    ...
    _en: Dict[str, str] = {
        ...
        "tab.ppe_inspection": "🔍 PPE Inspection",
        ...
        "telegram.help_employee": "Employee info (Surname)",
        "telegram.help_violation": "Violation info (#ID)",
        "telegram.help_company": "Company info (Name)",
        "telegram.help_report": "Generate report",
        "telegram.help_template": "Download template (Name)",
        "telegram.help_settings": "Notification settings",
        "telegram.help_menu": "Main menu",
        "telegram.no_company": "Company not found",
        "telegram.company_title": "Company info",
        "telegram.employee_title": "Employee info",
        "telegram.employee_not_found": "Employee not found",
        "telegram.violation_title": "Violation info",
        "telegram.violation_not_found": "Violation not found",
        "telegram.report_choose": "Choose report type:",
        "telegram.report_generating": "Generating report...",
        "telegram.report_ready": "Report ready:",
        "telegram.template_choose": "Choose template:",
        "telegram.template_not_found": "Template not found",
        "telegram.template_ready": "Template:",
        "telegram.settings_title": "Notification settings",
        "telegram.settings_hint": "To change prefs:\n/settings on — enable\n/settings off — disable",
        "telegram.settings_on": "Notifications enabled",
        "telegram.settings_off": "Notifications disabled",
        "telegram.menu_main": "OSH Enterprise Main Menu",
        "telegram.menu_employee": "👤 Employee",
        "telegram.menu_violation": "⚠ Violation",
        "telegram.menu_company": "🏢 Company",
        "telegram.menu_stats": "📊 Statistics",
        "telegram.menu_report": "📄 Report",
        "telegram.menu_help": "❓ Help",
        "telegram.pagination_template": "Page {page} of {total}",
        ...
        "settings.dark": "Dark",
        "settings.auto_save": "Auto-save (sec.)",
        ...
        "filter.name_prompt": "Preset name:",
        "filter.delete_confirm": "Delete preset «{name}»?",
        "templates.label": "Templates",
        "templates.save": "Save as template",
        "templates.delete": "Delete template",
        "templates.select": "-- select template --",
        "templates.name_prompt": "Template name:",
        "templates.delete_confirm": "Delete template «{name}»?",
        "validation.title": "Validation rules",
        "validation.hint": "Configure field validation rules for add/edit dialogs.",
        "validation.table": "Table",
        "validation.required": "Required field",
        "validation.min_len": "Min length:",
        "validation.max_len": "Max length:",
        "validation.pattern": "Regex pattern:",
        "validation.pattern_hint": "e.g.: ^\\+?\\d{10,15}$",
        "validation.pattern_msg_hint": "Error text on mismatch",
        "validation.error_title": "Validation error",
        "validation.errors_found": "Check fields marked in red:",
        "browser.pin_tab": "Pin tab",
        "browser.unpin_tab": "Unpin tab",
        "browser.duplicate_tab": "Duplicate tab",
        "browser.rename_tab": "Rename tab",
        "browser.rename_hint": "New name:",
        "ai.copy": "Copy",
        "common.copied": "Copied",
        "ai.ollama_title": "Local AI",
        "ai.ollama_suggestion": "We recommend installing Ollama for free local AI.\nDownload from https://ollama.ai and run it.",
    }
