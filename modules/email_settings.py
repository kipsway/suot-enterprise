...
class EmailSettingsWidget(QFrame):
    ...
    def _build_ui(self) -> None:
        ...
        self._enabled_cb = QCheckBox(I18n._("email.enabled"))
        ...
        self._tls_cb = QCheckBox(I18n._("email.use_tls"))
        ...
        show_cb = QCheckBox(I18n._("email.show_password"))
    ...
    def _load_values(self) -> None:
        ...
        try:
            self._port_spin.setValue(
                int(self.db.get_setting("email_smtp_port", "587")))
        except (ValueError, TypeError):
            self._port_spin.setValue(587)
        self._tls_cb.setChecked(
            self.db.get_setting("email_smtp_tls", "true") == "true")
    ...
    def _save_values(self) -> None:
        ...
        self.db.upsert_setting("email_smtp_tls",
                               "true" if self._tls_cb.isChecked() else "false")
    ...
    def _send_test(self) -> None:
        ...
        if not to_addr:
            ToastNotification.notify(
                I18n._("email.test_no_recipient"), "warning", 3000)
            return
        ...
        if err:
            ...
            ToastNotification.notify(
                I18n._("email.test_ok"), "success", 5000)
